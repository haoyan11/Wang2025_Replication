...
| 脚本 | 功能 | 语言 |
|------|------|------|
| `05b_SEM_analysis_dual_timescale_SOS.R` | 双时间尺度SEM（SOS→GPP→Fixed_Trate） | R |
| `05c_SEM_analysis_dual_timescale_robust_pooled_SOS.R` | Pooled SEM分析 | R |
| `05d_SEM_analysis_dual_timescale_lavaan_compare_SOS.R` | 像元级SEM对比（Ours/Other） | R |
...
- [ ] 或分步运行:
  ...
  - [ ] `Rscript 05b_SEM_analysis_dual_timescale_SOS.R` (可选，建议先运行以生成缓存)
  - [ ] `Rscript 05c_SEM_analysis_dual_timescale_robust_pooled_SOS.R` (可选)
  - [ ] `Rscript 05d_SEM_analysis_dual_timescale_lavaan_compare_SOS.R` (可选)
  - [ ] `python 06_plotting.py` (绘图，可选)
...
**修改文件**: `05c_SEM_analysis_dual_timescale_robust_pooled_SOS.R`
...
- `05c_SEM_analysis_dual_timescale_robust_pooled_SOS.R` - Pooled SEM分析
...
- ✅ `05c_SEM_analysis_dual_timescale_robust_pooled_SOS.R` - Pooled SEM
